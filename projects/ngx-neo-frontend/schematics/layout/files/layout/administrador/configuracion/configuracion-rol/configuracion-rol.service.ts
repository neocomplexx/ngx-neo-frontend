...
import { RoleServiceBackend } from '@neocomplexx/ngx-neo-frontend';
import { RoleDTO } from '@neocomplexx/ngx-neo-frontend';
import { PermissionDTO } from '@neocomplexx/ngx-neo-frontend';
import { UpdatePermissionsDTO } from '@neocomplexx/ngx-neo-frontend';
import { ModulePermissionsDTO} from '@neocomplexx/ngx-neo-frontend';
import { RoleModelDTO} from '@neocomplexx/ngx-neo-frontend';
import { PermissionServiceBackend  } from '@neocomplexx/ngx-neo-frontend';

@Injectable({
    providedIn: 'root'
})
export class ConfiguracionRolService {
